...
cv::Mat centers;
int K=2;
cv::kmeans(samples, K, labels, TermCriteria(cv::TermCriteria::EPS+cv::TermCriteria::COUNT, 10000, 0.0001), attempts, cv::KMEANS_PP_CENTERS, centers);
